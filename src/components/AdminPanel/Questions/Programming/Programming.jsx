    ...
    <section id="machine">
      <div className="machines">
        <div className="machines__cart">
          ...
          <div className="machines__cart__massage">
            <h3>Что такое матрицы и какие операции можно выполнить с ними?</h3>
            <p>20 минут назад</p>
            <div className="machines__cart__massage__btns">
              <button>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="18"
              ...
              <button>Комментарии 13</button>
              <button>Ответы 7</button>
            </div>
          </div>
        </div>
      </div>
