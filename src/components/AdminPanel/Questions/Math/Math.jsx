...
const Math = () => {
  return (
    <section id="math">
      <div className="maths">
        <div className="maths__cart">
          <div className="maths__cart__title">
            <div className="maths__cart__title__profil">
              <img
                ...
                alt="profil"
              />
              <div className="maths__cart__title__profil__text">
          ...
          <div className="maths__cart__massage">
            <h3>Что такое матрицы и какие операции можно выполнить с ними?</h3>
            <p>20 минут назад</p>
            <div className="maths__cart__massage__btns">
              <button>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="18"
              ...
              <button>Комментарии 15</button>
              <button>Ответы 2</button>
            </div>
          </div>
        </div>
        <div className="maths__cart">
